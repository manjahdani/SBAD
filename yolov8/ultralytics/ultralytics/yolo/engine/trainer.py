        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            if rank in {-1, 0}:
                ...
                if self.args.save or (epoch + 1 == self.epochs):
                    ckpt = self.save_model()
                    self.run_callbacks('on_model_save', 
                        ckpt = ckpt, 
                        final_epoch = final_epoch, 
                        fitness = self.fitness, 
                        best_model = self.fitness == self.best_fitness
                    )
                    del ckpt
            ...
            self.run_callbacks("on_fit_epoch_end", metrics = self.metrics, fitness = self.fitness)
        ...
        for f in self.last, self.best:
            if f.exists():
                ...
                if f is self.best:
                    ...
                    self.run_callbacks('on_fit_epoch_end', metrics = self.metrics, fitness = self.best_fitness)
